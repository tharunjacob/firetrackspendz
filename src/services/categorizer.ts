...
export const CONFIG = {
  ...
  category_mapping: {
    ...
    'salary': 'Salary', 'dividend': 'Other Income', 'interest': 'Other Income', 'refund': 'Other Income', 'payroll': 'Salary',
    'cashback': 'Other Income', 'bonus': 'Other Income',
  ...
  smart_patterns: [
    ...
    { regex: /^ACH\s?C/i, category: 'Other Income' },
    { regex: /^INT\.?\s?PD/i, category: 'Other Income' },
