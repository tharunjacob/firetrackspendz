          ...
          <div className="lg:hidden flex items-center justify-between px-4 py-2.5 bg-white dark:bg-slate-800 border-b border-slate-200 dark:border-slate-700 shrink-0 min-h-[52px]">
            ...
            {transactions.length > 0 && (
              <button
                ...
                className="relative flex items-center gap-1.5 px-3 py-2 text-sm font-medium rounded-lg bg-slate-100 dark:bg-slate-700 text-slate-700 dark:text-slate-200 min-h-[44px] min-w-[44px]"
              >
