...
// Data URI for the logo used in Layout.tsx to ensure immediate rendering without external requests
...
export const Icon = ({ name, className = "" }: { name: string, className?: string }) => {
    const icons: Record<string, React.ReactElement> = {
        ...
        snapshot: <path strokeLinecap="round" strokeLinejoin="round" d="M6.827 6.175A2.31 2.31 0 015.186 7.23c-.38.054-.757.112-1.134.175C2.999 7.58 2.25 8.507 2.25 9.574V18a2.25 2.25 0 002.25 2.25h15A2.25 2.25 0 0021.75 18V9.574c0-1.067-.75-1.994-1.802-2.169a47.865 47.865 0 00-1.134-.175 2.31 2.31 0 01-1.64-1.055l-.822-1.316a2.192 2.192 0 00-1.736-1.039 48.774 48.774 0 00-5.232 0 2.192 2.192 0 00-1.736 1.039l-.821 1.316z" />,
        ...
        calendar: <path strokeLinecap="round" strokeLinejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25m-18 0A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75m-18 0v-7.5A2.25 2.25 0 015.25 9h13.5A2.25 2.25 0 0121 9v7.5m-17.693 2.569c.945-.87 2.26-1.544 4.193-1.544 1.933 0 3.248.674 4.193 1.544m5.652 2.565c.955-.116 1.804-.428 2.517-.938 1.49-.823 2.518-2.58 2.518-4.675a6.002 6.002 0 00-6.001-6.001 6.002 6.002 0 00-5.999 5.999c0 2.096 1.027 3.854 2.518 4.676" />
    };
    ...
    return (
        <svg 
            ...
            stroke="currentColor" 
            className={className}
            // CRITICAL: Explicit dimensions as DOM fallback. 
            // Tailwind classes (w-6) will override this via CSS, but this saves us if CSS fails.
            width="24"
            height="24"
            style={{ display: 'inline-block', flexShrink: 0 }}
        >
            {icons[name] || icons['flash']}
        </svg>
    );
};